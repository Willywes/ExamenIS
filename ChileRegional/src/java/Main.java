...
//        List<TipoPersonalDTO> lista = new TipoPersonalDAO().listarTodos();
//
//        for (TipoPersonalDTO item : lista) {
//            System.out.println("id " + item.getId() + " - Nombre " + item.getNombre());
//        }
        // prubas personal
//        PersonalDTO personal = new PersonalDTO(1, 16483941, "9","1234", "IRON", "MAN", "SUPER", 322959896, "alejandro@gmail.com", true, new TipoPersonalDAO().buscarPorId(2));
//
